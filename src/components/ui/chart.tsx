              ...
              (
                ...
                return (
                  <div
                    ...
                    className="flex items-center gap-1.5 [&>svg]:w-3 [&>svg]:h-3 [&>svg]:text-muted-foreground"
                  >
                    {itemConfig?.icon &&
                    !hideIcon ? (
                      <itemConfig.icon />
...
function getPayloadConfigFromPayload(
  ...
  const payloadPayload =
    typeof payloadObject.payload ===
      "object" &&
    payloadObject.payload !== null
      ? (payloadObject.payload as Record<
          string,
          unknown
        >)
      : undefined;
