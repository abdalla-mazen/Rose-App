...
const GALLERY = [
  ...
  [
    { id: 3, src: "/assets/images/gallery/2.png", alt: "Red gift box" },
    { id: 4, src: "/assets/images/gallery/5.png", alt: "Ring in box with flowers" },
  ],
  [
    { id: 5, src: "/assets/images/gallery/3.png", alt: "Ring with flowers" },
    { id: 6, src: "/assets/images/gallery/6.png", alt: "Engagement card and ring" },
  ],
];
...
export default function Gallery() {
  ...
  return (
    <section className="flex flex-col items-center gap-10 mx-auto my-20 w-11/12 max-w-7xl text-center">
      {/* Header */}
      <div className="flex flex-col items-center gap-2 w-full font-bold">
        <span className="text-softPink-500 dark:text-maroon-400 text-sm uppercase tracking-widest">
          {t("gallery")}
        </span>
        ...
        <h2 className="flex justify-center items-center gap-2 text-maroon-700 dark:text-softPink-200 text-2xl sm:text-3xl lg:text-4xl capitalize">
          {t.rich("gallery-title", {
            ...
            span1: (chunk) => (
              <span className="after:block after:bg-softPink-600 dark:after:bg-softPink-500 after:w-full after:h-[2px] after:translate-y-1">
                {chunk}
              </span>
            ),
          })}
