            ...
            <div className="relative w-96 h-[433px]">
              ...
              <div
                className={`absolute top-28 ${rtlClass(
                  ...
                  "right-7",
                  locale
                )} w-80 h-60 bg-white rounded-3xl shadow-[0px_4px_50.5px_0px_rgba(116,28,33,0.1)]
                flex flex-col items-center text-center px-5 pt-14 pb-5 gap-3`}
              >
                <h3 className="font-sarabun font-semibold text-zinc-800 text-base">
                  {item.user.firstName} {item.user.lastName}
                </h3>
